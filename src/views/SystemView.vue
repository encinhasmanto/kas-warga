  ...
  <div class="max-w-4xl mx-auto space-y-6 pb-20">
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      <div class="md:col-span-1 space-y-6">
        <div
          class="bg-white dark:bg-slate-900 rounded-2xl p-6 border border-primary/10 shadow-sm overflow-hidden relative group"
        >
          <div
          ...
          <div class="relative flex flex-col items-center text-center">
            <div class="relative mb-4">
              <div
                class="size-24 rounded-full border-4 border-white dark:border-slate-800 shadow-xl overflow-hidden bg-slate-100 dark:bg-slate-800"
              >
                <img
                  :src="
                    unitData?.avatar_url ||
                    `https://api.dicebear.com/7.x/avataaars/svg?seed=${unitData?.name || 'Unit'}`
                  "
            ...
            >
              <div
                class="w-full h-1 bg-slate-100 dark:bg-slate-800 rounded-full overflow-hidden"
              >
                <div class="h-full bg-primary animate-progress w-full"></div>
              </div>
              <p class="text-[10px] uppercase font-black text-primary mt-2">
                Uploading...
              </p>
            </div>
          </div>
      ...
      <div class="md:col-span-2 space-y-6">
        ...
        <div
          v-if="session?.type === 'resident'"
          class="bg-white dark:bg-slate-900 rounded-2xl border border-primary/10 shadow-sm overflow-hidden"
        >
          <div class="p-6 border-b border-primary/5">
            <div class="flex items-center gap-3">
              <div
                class="size-10 bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400 rounded-xl flex items-center justify-center"
              >
        ...
        >
          <div class="p-6 border-b border-primary/5">
            <div class="flex items-center gap-3">
              <div
                class="size-10 bg-blue-100 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-xl flex items-center justify-center"
              >
    ...
    <teleport to="body">
      ...
      <transition name="modal">
        ...
        >
          ...
          ></div>
          <div
            class="relative bg-white dark:bg-slate-900 w-full max-w-sm rounded-2xl p-8 shadow-2xl flex flex-col items-center text-center"
          >
            <div
              class="size-20 bg-emerald-100 dark:bg-emerald-900/30 text-emerald-500 rounded-full flex items-center justify-center mb-6 scale-animate"
            >
...
onMounted(async () => {
  if (session.value?.id) {
    ...
    profileSub = subscribeToProfileChanges(
      session.value.type,
      session.value.id,
      (newData) => {
