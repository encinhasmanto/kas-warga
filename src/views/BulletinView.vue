          ...
          <form class="space-y-4" @submit.prevent="handlePublish">
            ...
            <div>
              ...
              <div class="space-y-2">
                ...
                <div v-if="selectedFile" class="flex items-center gap-2 text-[10px] text-emerald-600 font-bold bg-emerald-50 dark:bg-emerald-900/20 px-3 py-2 rounded-lg">
                  ...
                  {{ selectedFile.name }}
                  <button type="button" @click="clearFile" class="ml-auto text-slate-400 hover:text-rose-500"><span class="material-symbols-outlined text-[14px]">close</span></button>
                </div>
                <!-- Fallback: URL Option -->
                <div v-if="!selectedFile" class="space-y-1">
                  <p class="text-[10px] text-slate-400 font-medium">— or paste content URL —</p>
                  <input 
            ...
            <div class="flex gap-3 pt-4">
              ...
              >
                ...
                {{ isSubmitting ? 'Processing...' : (isEditing ? 'Update Bulletin' : 'Publish Now') }}
              </button>
            </div>
            ...
            <div v-if="isUploading" class="pt-2">
              ...
              <div class="w-full bg-slate-100 dark:bg-slate-800 rounded-full h-1.5 overflow-hidden">
                <div class="bg-primary h-full rounded-full transition-all duration-300 ease-out" :style="`width: ${uploadProgress}%`"></div>
              </div>
            </div>
          </form>
        </div>
          ...
          <div v-for="bulletin in bulletins" :key="bulletin.id" class="bg-white dark:bg-slate-900 border border-primary/10 rounded-xl overflow-hidden shadow-sm group">
            ...
            <div class="h-40 md:h-32 bg-slate-100 dark:bg-slate-800 relative overflow-hidden">
              ...
              <div v-else-if="getFileType(bulletin.content_url) === 'pdf'" class="w-full h-full flex flex-col items-center justify-center bg-rose-50 dark:bg-rose-900/20">
                ...
                <p class="text-[10px] font-bold text-rose-500 mt-1">PDF Document</p>
              </div>
              <!-- No attachment -->
            ...
            <div class="p-5">
              ...
              <div v-if="bulletin.content_url" class="mb-3">
                <a 
                  ...
                  :href="bulletin.content_url" target="_blank"
                ...
                >
                  <span class="material-symbols-outlined text-[14px]">play_circle</span> Play Video
                </a>
                <a 
                ...
                >
                  <span class="material-symbols-outlined text-[14px]">picture_as_pdf</span> Open PDF
                </a>
                <a 
                ...
                >
                  <span class="material-symbols-outlined text-[14px]">open_in_new</span> View Full Image
                </a>
              </div>
...
const handleResize = () => { isLgScreen.value = window.innerWidth >= 1024 }
